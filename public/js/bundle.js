...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaXJhbmt1bmRhZmFicmljZSIsImEiOiJjazlkOWFtY2UwMTM2M3BxcmRtY3F1dXllIn0.StSOiDKFRsIxzDGlIKPONg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/irankundafabrice/ck9ddkm5y0pr71iqpdsyleui8',
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            (0, _alerts.showAlert)('error', 'logging out failed! Please try again later.');
...
var stripe = Stripe('pk_test_FMX2Sm0Vvx1gCrp4tjA7lXIF00Kiuinv6E');
